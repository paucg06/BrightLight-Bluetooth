...
## 🚀 Características
- ⚡ **Sin instalación**: Funciona directamente desde el navegador (Chrome, Edge, Opera).
...
- 🌈 **Efectos dinámicos**: Modos de desvanecimiento (Fade), estroboscópico, saltos y regulación de velocidad.
...
4. Guarda y accede a la URL generada (`https://paucg06.github.io/SmartLight-Bluetooth/`).
